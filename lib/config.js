...
export const Config = z.object({
    ...
    runtime: z.object({
        mode: z.union(['external']).default('external'),
...
export function resolveConfig(config = {}) {
    ...
    if (mode !== 'external') {
        throw new VisionToolkitError('config', 'runtime.mode "managed" is planned for P1; configure runtime.mode: external and point agentVisionToolkitPath at an installed agent-vision-toolkit checkout');
    }
