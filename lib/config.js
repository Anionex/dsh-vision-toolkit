...
export { BUILT_IN_FREE_VISION_BASE_URL, BUILT_IN_FREE_VISION_CREDENTIAL, BUILT_IN_FREE_VISION_MODEL, } from "./defaults.js";
...
export const Config = z.object({
    provider: z.object({
        ...
        protocol: z.union(['openai', 'anthropic', 'responses']).default('openai'),
