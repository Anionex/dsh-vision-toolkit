...
export class ImageInputVariantAdapter extends LlmAdapter {
    ...
    async *stream(options) {
        ...
        const messages = await convertImagesToEvidence(this.ctx, () => captured, this.cache, options.messages, options.signal, options.sessionId === undefined ? undefined : String(options.sessionId), captured?.evidenceFingerprint ?? 'process-only-runtime', storageDir);
