...
import { installImageInputVariants, sessionPasteTakeover } from "./image-input-variants.js";
...
export async function apply(ctx, config = {}) {
    ...
    installVisionToolkitWeb(ctx, backend, artifacts, pastedImages, sessionId => sessionPasteTakeover(ctx, sessionId));
