...
function draftOf(value) {
    return {
        ...
        reasoningEffort: value.provider?.reasoningEffort ?? '',
...
function valueOf(draft, t) {
    return {
        provider: {
            ...
            ...(draft.reasoningEffort.trim().length === 0 ? {} : { reasoningEffort: draft.reasoningEffort.trim() }),
