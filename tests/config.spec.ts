...
describe('resolveConfig', () => {
  it('applies documented defaults', () => {
    ...
    expect(config.imageInputVariants).toEqual({ enabled: true, providers: [] })
  })
  ...
  it('normalizes image-input variant settings', () => {
    ...
    expect(config.imageInputVariants).toEqual({ enabled: false, providers: ['deepseek-official', 'glm'] })
    expect(resolveConfig({ imageInputVariants: {} }).imageInputVariants).toEqual({ enabled: true, providers: [] })
  })
