...
- **内置免费额度。** 共享服务提供每客户端每天 300 次、全局每天 5,000 次和每 60 秒 60 次突发请求额度，并在触发限制时返回明确原因。
...
- **2026-08-16 · 免费额度：** Groq 账号池扩展到五个，全局额度提高到 `5,000/日`，单客户端提高到 `300/日`，突发限制保持 `60/分钟`。
