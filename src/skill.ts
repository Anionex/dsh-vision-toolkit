...
The other visual operations are local. Runtime health, connection testing, and
plugin/upstream version information stay in Vision Toolkit Web Settings rather
than occupying the model's tool context.
