...
check(pkg.version === '0.1.0', 'package version and the initial release notes must stay aligned')
...
check(pkg.homepage === 'https://dsh-external.github.io/dsh-vision-toolkit/', 'homepage URL is missing or mismatched')
